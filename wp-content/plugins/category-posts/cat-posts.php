<?php
/*
Plugin Name: Modified Category Posts Widget
Description: Adds a widget that can display posts from a single category.
Author: James Lao - Modified by Jon Sisk	
Version: jon.3.3
*/
...
// Post list
	...
	?>
		<li class="cat-post-item">
			...
			<?php endif; ?>
			<a href="<?php echo the_permalink()?>"><span class="moreinfo">More info &raquo;</span></a>
		</li>
	<?php
	}
	echo "</ul>\n";
...
?>
    ...
    <p>
		...
		<p>
			<label for="<?php echo $this->get_field_id("date_meta"); ?>">
				<input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("date_meta"); ?>" name="<?php echo $this->get_field_name("date_meta"); ?>"<?php checked( (bool) $instance["date_meta"], true ); ?> />
				<?php _e( 'Show post Date custom meta for events' ); ?>
			</label>
		</p>
